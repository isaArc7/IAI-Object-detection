...
# command: python train_val_split.py --datapath=<path> --train_pct=0.9
...
cwd = os.getcwd()
train_img_path = os.path.join(cwd,'custom_data/train/images')
train_txt_path = os.path.join(cwd,'custom_data/train/labels')
val_img_path = os.path.join(cwd,'custom_data/valid/images')
val_txt_path = os.path.join(cwd,'custom_data/valid/labels')
...
# Define classes.txt input and output path
source_path = os.path.join(data_path, 'classes.txt')
destination_path = os.path.join(cwd,'custom_data/classes.txt')
# Copy classes.txt over
